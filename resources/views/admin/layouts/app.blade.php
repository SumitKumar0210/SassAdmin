...
<html lang="en">
  ...
  <body>
    ...
    <div class="page-wrapper compact-sidebar compact-small material-icon" id="pageWrapper">
      <div class="d-flex">
        <!-- sidebar-wrapper Start-->
         @include('admin.components.app.sideMenu')
        <div class="vertical-layout-body">
          ...
          <div class="page-sub-header" data-layout="stroke-svg"> 
            <!-- <div class="body-header">
              <ul class="sidebar-body-menu">
                <li>
                  <div> <a href="../template/index.html" target="_blank"> 
                      <h3 class="lan-1">Black Quality</h3><span class="lan-2">Dashboards,widgets.</span></a></div>
                </li>
                <li>
                  <div> 
                    <h3>Starter kit</h3><span class="lan-4">Ready To Use Apps</span>
                  </div>
                  <ul class="sidebar-body-mainmenu"> 
                    <li> <a href="#"> 
                        <svg class="stroke-icon">
                          <use href="{{asset('admin/assets/svg/icon-sprite.svg')}}#stroke-animation"></use>
                        </svg>
                        <svg class="fill-icon">
                          <use href="{{asset('admin/assets/svg/icon-sprite.svg')}}#fill-animation"></use>
                        </svg>Color version </a><span class="sub-body-arrow"><i class="fa fa-angle-right"></i></span>
                    ...
                    <li> <a href="#"> 
                        ...
                        </svg>Page layout</a><span class="sub-body-arrow"><i class="fa fa-angle-right"></i></span>
                      <ul class="sidebar-body-submenu custom-scrollbar"> 
                        <li><a href="boxed.html">Boxed</a></li>
                        <li><a href="layout-rtl.html">RTL</a></li>
                      </ul>
                    </li>
                    <li> <a href="hide-on-scroll.html"> 
                        <svg class="stroke-icon">
                    ...
                    <li> <a href="#"> 
                        ...
                        </svg>Footers</a><span class="sub-body-arrow"><i class="fa fa-angle-right"></i></span>
                      <ul class="sidebar-body-submenu custom-scrollbar"> 
                ...
                <li>
                  <div> <a href="https://support.pixelstrap.com/portal/en/signin" target="_blank"> 
                      <h3>Raise Support</h3><span>Customer Support</span></a></div>
                </li>
                <li>
                  <div> <a href="https://docs.pixelstrap.com/Boho/html/document/" target="_blank"> 
                      <h3>Documentation </h3><span>For Better Experience</span></a></div>
                </li>
              </ul>
            </div> -->
          </div>
          ...
          <div class="page-body-wrapper horizontal-menu">
                ...
                <nav class="sidebar-main">
                  ...
                  <div id="sidebar-menu">
                    <ul class="sidebar-links vertical-menu-mobile" id="simple-bar">
                      <li class="active-page-link active">
            ...
            @yield('content')
            <!-- footer start-->
            @include('admin.components.app.footer')
          </div>
        </div>
      </div>
    </div>
    ...
    <script src="{{asset('admin/assets/js/sweet-alert/custom-message.js')}}"></script>
