                      ...
                      <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.html">                                       
                            <svg class="stroke-icon">
                              <use href="{{asset('admin/assets/jssvg/icon-sprite.svg')}}#breadcrumb-home"></use>
                            </svg></a></li>
                ...
                <div class="row starter-main">
                  <div class="col-sm-12">
                    <div class="card">
                      ...
                      <div class="card-body">
                        <p>Getting start with your project custom requirement using a ready template which is quite difficult and time taking process, Boho Admin provides useful features to kick start your project development with no efforts !</p>
                        <ul>
                          <li>
                            <p>Boho Admin provides you getting start pages with different layouts, use the layout as per your custom requirements and just change the branding, menu & content.</p>
                          </li>
                          <li>
                            <p>Every components in Boho Admin are decoupled, it means use only components you actually need! Remove unnecessary and extra code easily just by excluding the path to specific SCSS, JS file.</p>
                          </li>
                          <li>
                        ...
                        <div class="code-box-copy">
                          ...
                          <pre><code class="language-html" id="example-head">&lt;!-- Cod Box Copy begin --&gt;
                            &lt;p&gt;Getting start with your project custom requirements using a ready template which is quite difficult and time taking process, Boho Admin provides useful features to kick start your project development with no efforts !&lt;/p&gt;
                            &lt;ul&gt;
                            &lt;li&gt;&lt;p&gt;Boho Admin provides you getting start pages with different layouts, use the layout as per your custom requirements and just change the branding, menu & content.&lt;/p&gt;&lt;/li&gt;
                            &lt;li&gt;&lt;p&gt;Every components in Boho Admin are decoupled, it means use only components you actually need! Remove unnecessary and extra code easily just by excluding the path to specific SCSS, JS file.&lt;/p&gt;&lt;/li&gt;
                  ...
                  <div class="col-sm-12">
                    <div class="card">
                      ...
                      <div class="card-body">
                        <p><span class="f-w-700">HTML</span></p>
                        ...
                        <p><span class="f-w-700">PUG</span></p>
                  ...
                  <div class="col-sm-12">
                    <div class="card">
                      ...
                      <div class="card-body">
                        <h4 class="f-w-700">HTML Ipsum Presents</h4>
                        ...
                        <h4 class="f-w-700">Header Level 2</h4>
                        <ol>
                        ...
                        <h4 class="f-w-700">Header Level<span> 3</span></h4>
                        <ul>
                          <li>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</li>
                          <li>Aliquam tincidunt mauris eu risus.</li>
                        </ul>
