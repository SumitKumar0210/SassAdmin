          ...
          <div class="tm_invoice_content">
            ...
            <div class="tm_grid_row tm_col_2 tm_invoice_info_in tm_round_border tm_mb30" style="grid-template-columns: repeat( 2, 1fr);">
             <div class="tm_border_none_sm">
                ...
                <p class="tm_m0">Name: {{$reservation?->primary_name ?? ''}}</p>
                <p class="tm_m0">Room Number: {{$reservation?->room_alloted ?? ''}}</p>
              </div>
            </div>
                  ...
                  <tbody>
                    ...
                    @foreach($paymentList as $list)
                      <tr>
                        ...
                        <td style="text-align: left;">{{$list['amount']}}</td>
                        <td style="text-align: left;">{{$list['mode']}}</td>
