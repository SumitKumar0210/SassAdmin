...
/* LEFT SIDE – flexible, full height */
.kot-leftside {
    flex: 1;
    min-width: 0;
    display: flex;
...
/* Each left card takes equal height */
.kot-leftside .card {
    flex: 1;
    display: flex;
    flex-direction: column;
...
.kot-rightside .card {
    height: calc(100vh - 320px); /* adjust if header height changes */
    display: flex;
    flex-direction: column;
    overflow-y: auto;
}

/* Scroll content inside right card */
            ...
            <div class="kot-layout">
                ...
                <div class="kot-leftside">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body vertical-scroll">
                            <div class="kot-wrapper running_kot_room_orders">
                                <!-- running kots -->
                            </div>
                        </div>
                    </div>
                ...
                <div class="kot-rightside">
                    <div class="card h-100 mb-0">
                        ...
                        <div class="card-body scroll-kots-completed">
                            <div class="kot-wrapper completed-kots">
                                <!-- completed kots -->
                            </div>
                        </div>
                    </div>
