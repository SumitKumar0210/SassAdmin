            ...
            <div class="page-title mt-2">
                <div class="row gx-0">
                    <div class="col-12 col-sm-6">
                        <h3 class="d-block">Running KOT List</h3>
                    </div>
                    <div class="col-12 col-sm-6">
                        {{-- <div class="float-end">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="hover row-border stripe" id="kot-running-table">
                                    <thead>
                                        <tr>  
                                            <th>KOT Id</th>
                                            <th>Type</th>
...
<script>
    ...
    const runningKotData = "{{route('kot.runningKotData')}}";
...
{{-----------external js files added for page functions------------}}
  <script src="{{asset('backend/assets/js/custom/kot/running-kot.js')}}"></script>
