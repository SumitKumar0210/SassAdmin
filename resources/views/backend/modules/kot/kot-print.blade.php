    ...
    <div class="tm_container">
        <div class="tm_pos_invoice_wrap" id="tm_download_section">
            <div class="tm_pos_invoice_top">
                ...
                <div class="tm_pos_company_name">{{$hotel[0]->name}}</div>
            ...
            <div class="tm_pos_invoice_body">
                <div class="tm_pos_invoice_heading"><span>KITCHEN ORDER TICKET</span></div>
                <ul class="tm_list tm_style1">
                    ...
                    <li>
                        <div class="tm_list_title">KOT No:</div>
                    ...
                    <li class="text-right">
                        <div class="tm_list_title">KOT Type:</div>
                        <div class="tm_list_desc">{{$basic_detail['payment_type']}}</div>
                    </li>
                    <li>
                        <div class="tm_list_title">STW Name:</div>
                        <div class="tm_list_desc">{{$basic_detail['waiter']}}</div>
                    </li>
                    <li class="text-right">
                        <div class="tm_list_title">Prepared By:</div>
                        <div class="tm_list_desc">{{$basic_detail['bill_by']}}</div>
                    </li>
                </ul>
                ...
                <div class="tm_pos_sample_text">
                    <p style="float: right;">Signature F.O Manager</p>
                </div>
            </div>
        </div>
