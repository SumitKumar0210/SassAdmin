            ...
            <div class="page-title mt-2">
                <div class="row gx-0">
                    <div class="col-12 col-sm-6">
                        <h3 class="d-block">Single Booking Sale Report</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        $(document).ready(function() { 
            ...
            table = $('#reservation_room_table123').DataTable({
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        title: 'Single Booking Sale Report'
                    },
                    {
                        extend: 'csvHtml5',
                        title: 'Single Booking Sale Report'
                ...
                ajax: {
                    url: "{{ route('singleBookingSaleReport.singleBookingSaleReportView') }}",
                    type: 'GET',
                    data: function(d) {
                ...
                columns: [
                    ...
                    { data: 'days', name: 'days', orderable: false, searchable: true },
                    { data: 'room_price', name: 'room_price', orderable: false, searchable: true },
