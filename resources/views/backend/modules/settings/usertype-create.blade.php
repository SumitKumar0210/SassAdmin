                            ...
                            <div class="page-title mt-2">
                                <div class="row gx-0">
                                    <div class="col-12 col-sm-6">
                                        <h3 class="d-block">Add Usertype</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm" placeholder="Usertype" name="usertype_name">
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="card-wrapper border rounded-3 checkbox-checked">
                                                            ...
                                                            @foreach ($mod['items'] as $item)
                                                                <div class="form-check form-switch">
                                                                    <input class="form-check-input check-size" name="permissions[]" id="flexSwitchCheckDefault{{$item->id}}" type="checkbox" role="switch" value="{{$item->id}}"><label class="form-check-label" for="flexCheckDefault{{$item->id}}">{{$item->module_option}}</label>
                                                                </div>
                                                            @endforeach
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-12 d-flex justify-content-end mt-3 itemAddShow ">
                                                <button type="button" class="btn btn-success btn-sm fw-medium m-2 usertypeAddSubmit" onclick="addUsertype()">
                                                Submit
                                                </button>
...
@section('extra-js')
<script>
    const usertypeAdd = "{{ route('usertype.store') }}";
