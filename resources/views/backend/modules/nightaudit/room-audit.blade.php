...
@section('title','Nightaudit Room Audit')
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-sm-6 p-0">
                    <h3>Inventory/Room Audit</h3>
                </div>
                <div class="col-12 col-sm-6 p-0 text-end">
                    <button class="btn btn-primary ms-2" type="button" onclick="exportRoomAudit()"><i class="ri-file-excel-line"></i> Export Summary</button>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card widget-1">
                  <div class="card-body"> 
                    <div class="widget-content">
                      ...
                      <div> 
                        <h4>{{$total_rooms}}</h4><span class="f-light">Rooms</span>
                      </div>
                    </div>
                ...
                <div class="card widget-1">
                  <div class="card-body"> 
                    <div class="widget-content">
                      ...
                      <div> 
                        <h4>{{$arrival}}</h4><span class="f-light">Checked-in</span>
                      </div>
                    </div>
                ...
                <div class="card widget-1">
                  <div class="card-body"> 
                    <div class="widget-content">
                      ...
                      <div> 
                        <h4>{{$departure}}</h4><span class="f-light">Checked-out</span>
                      </div>
                    </div>
                ...
                <div class="card widget-1">
                  <div class="card-body"> 
                    <div class="widget-content">
                      ...
                      <div> 
                        <h4>{{$total_closure}}</h4><span class="f-light">Closure</span>
                      </div>
                    </div>
                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap flex-md-nowrap mb-sm-4">
                    <div class="card small-widget w-100 mb-sm-0 me-sm-4">
                      <div class="card-body primary"> 
                        <h5 class="mb-2 f-dark">Occupied Rooms</h5>
                        <div class="d-block">
                          <h4 class="mb-2">{{$room_occupied}}</h4>
                          <h6 class="f-light f-14 f-w-600 d-block">{{$booking_per}}%</h6>
                        </div>
                    ...
                    <div class="card small-widget w-100 mb-sm-0 me-sm-4">
                      <div class="card-body secondary"> 
                        <h5 class="mb-2 f-dark">Vacant Available</h5>
                        <div class="d-block">
                          <h4 class="mb-2">{{$room_vacant}}</h4>
                          <h6 class="f-light f-14 f-w-500">{{$room_vacant_per}}%</h6>
                        </div>
                        <div class="bg-gradient"> 
                          <svg class="stroke-icon svg-fill">
                            <use href="{{asset('backend/assets/svg/icon-sprite.svg#new-order')}}"></use>
                    ...
                    <div class="card small-widget w-100 mb-sm-0 me-sm-4">
                      <div class="card-body warning"> 
                        <h5 class="mb-2 f-dark">Vacant Blocked</h5>
                        <div class="d-block">
                          <h4 class="mb-2">{{$block_vacant}}</h4>
                          <h6 class="f-light f-14 f-w-500">{{$block_vacant_per}}%</h6>
                        </div>
                        <div class="bg-gradient"> 
                          <svg class="stroke-icon svg-fill">
                            <use href="{{asset('backend/assets/svg/icon-sprite.svg#new-order')}}"></use>
                    ...
                    <div class="card small-widget w-100 mb-sm-0 me-sm-4">
                      <div class="card-body success"> 
                        <h5 class="mb-2 f-dark">Check-out</h5>
                        <div class="d-block">
                    ...
                    <div class="card small-widget w-100 mb-sm-0">
                      <div class="card-body secondary"> 
                        <h5 class="mb-2 f-dark">Under Cleaning</h5>
                        <div class="d-block">
                          <h4 class="mb-2">{{$under_cleaning}}</h4>
                          <h6 class="f-light f-14 f-w-500">Today</h6>
                        </div>
                        <div class="bg-gradient"> 
                          <svg class="stroke-icon svg-fill">
                                ...
                                <tbody>
                                  @foreach ($closedRoomList as $item)
                                    <tr>
                                      ...
                                      <td><a href="javascript:;" onclick="checkRoomClose({{$item['id']}},1)"><i class="icon-pencil-alt"></i></a></td>
                                    </tr>
                                  @endforeach
                                </tbody>
                            </table>
...
<script>
  ...
  function exportRoomAudit(){
    window.open('/nightaudit/room-audit-print');
  }
</script>
