...
const selected = document.querySelector(".selected-box1");
const optionsContainer = document.querySelector(".options-container1");
const searchBox = document.querySelector(".search-box1 input");

const optionsList = document.querySelectorAll(".selection-option1");
