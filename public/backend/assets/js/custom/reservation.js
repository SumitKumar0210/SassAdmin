...
function edit_reservation(id, reservationid) {
    ...
    // var firstTab = $('#EditReservation a:first');
    // firstTab.tab('show');
    // $('.validation_error_msg').html('');
    // $('.validation_error_msg').removeClass('is_invalid');
    // $('.form-control').removeClass('is_field_invalid');
    // $('.form-select').removeClass('is_field_invalid');
    ...
    //                                     kot_payment +=`<button class="btn btn-primary" onClick="recordKotPayment(${kot_detail_view.id},${kot_detail_view.grand_total})">Record Payment</button>`;
    //                                 }else{
    //                                      kot_payment +=`<button class="btn btn-outline-info" onClick="printKot('${kot_detail_view.kot_id}')">Print</button>`;
    //                                 }
    //                                 kot_payment +=`</td>
    //                             </tr>`;
    //             });
...
function addNewGuest(){
    ...
    let newGuest = '';
    newGuest +=`<div class="room-guest-bar border-radius-4 my-2 px-3 py-2 bg-light g-tab-element addroomguest">
                    <div class="row">
                        <div class="col">
                            <div class="mb-3 mb-lg-1">
                                <label class="form-label text-dark" for="name_g_rsv_add">Name</label>
                                <input class="form-control form-control-sm" id="name_g_rsv_add" name="name_g_rsv_add[]" type="text" required>
                                <div class="name_g_rsv_add_class"></div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="mb-3 mb-lg-1">
                                <label class="form-label text-dark" for="mobile_g_rsv_add">Mobile Number</label>
                                <input class="form-control form-control-sm" id="mobile_g_rsv_add" name="mobile_g_rsv_add[]" type="number" maxlength="10" autocomplete="off" pattern="[1-9]{1}[0-9]{9}" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" title="Please enter exactly 10 digits" required>
                                <div class="mobile_g_rsv_add_class"></div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="mb-3 mb-lg-1">
                                <label class="form-label text-dark">Gender</label>
                                <select class="form-select form-control-sm" id="gender_g_rsv_add" name="gender_g_rsv_add[]" required>
                                    <option value="">Select</option>
                        ...
                        <div class="col">
                            <div class="mb-3 mb-lg-1">
                                <label class="form-label text-dark">Document Type</label>
                                <select class="form-select form-select-sm" id="doc_g_rsv_add" name="doc_g_rsv_add[]" required>
                                    <option value="">Select</option>
                        ...
                        <div class="col">
                            <div class="mb-3 mb-lg-1">
                                <label class="form-label text-dark">Id Number</label>
                                <input class="form-control form-control-sm" id="idnum_g_rsv_add" name="idnum_g_rsv_add[]" type="text" maxlength="15" oninput="this.value=this.value.slice(0,15)" required>
                                <div class="email_g_rsv_class"></div>
                            </div>
                        </div>
                        <div class="col">
                        ...
                        <div class="d-flex align-items-center justify-content-center g-tab-remove1" style="width:20px;height:20px;margin-top:28px;" onclick="deleteGuestRow(this)">
                            <i class="icon-close bg-danger p-1 rounded-circle formclosebtn1" style="font-size:10px"></i>
                        </div>
                    </div>
                </div>`;
...
function addPrimaryAsGuest(){
    ...
    $('#doc_g_rsv_add_new').html(` <option value="Aadhar Card" ${currentReservationDetail['document_type'] == "Aadhar Card" ? 'selected' : ''}>Aadhar Card</option>
...
$('#record_kot_pmode').on('change',function(e){
    e.preventDefault();
    let pmode = $('#record_kot_pmode').val();
     if(pmode == '1' || pmode == ''){
        $('.txnVisibility').addClass('d-none');
     }else{
        $('.txnVisibility').removeClass('d-none');
...
function recordKotPayment(x,amount){
    $('#kotPaymentModel').modal('show');
    $('.record_kot_id').val(x);
    $('#record_kot_amount_total').val(amount);
    $('#record_kot_amount').val(amount);
}

$('#record_kot_payment_form').on('submit', function(e) {
   
    e.preventDefault();
    let total = $('#record_kot_amount_total').val();
    let id = $('.record_kot_id').val();
    let amount = $('#record_kot_amount').val();
    let mode = $('#record_kot_pmode').val();
    let txn = $('#record_kot_txn').val();
    ...
    if(amount > total){
        ...
        if (amount <= 0) {
            ...
            $('.payment_collecting_submit').addClass('d-none');
            $('.payment_processing').removeClass('d-none');
...
function updateReservation() {
    ...
    if (name_resvn_EditValid === true && mobile_resvn_EditValid === true && state_resvn_EditValid === true){
        $('.update_res_Btn').addClass('d-none');
        ...
        formData.append('gstLegalName', $('#gstLegalName_edit').val());
        formData.append('gstAddrBnm', $('#gstAddrBnm_edit').val());
        formData.append('gstAddrBno', $('#gstAddrBno_edit').val());
        formData.append('gstAddrFlno', $('#gstAddrFlno_edit').val());
        formData.append('gstAddrSt', $('#gstAddrSt_edit').val());
        formData.append('gstAddrLoc', $('#gstAddrLoc_edit').val());
        formData.append('gstTxpType', $('#gstTxpType_edit').val());
        formData.append('gstStatus', $('#gstStatus_edit').val());
        formData.append('gstBlkStatus', $('#gstBlkStatus_edit').val());
        formData.append('gstDtReg', $('#gstDtReg_edit').val());
        formData.append('gstDtDReg', $('#gstDtDReg_edit').val());
        formData.append('gstTradeName', $('#gstTradeName_edit').val());
        formData.append('gstStateCode', $('#gstStateCode_edit').val());
        formData.append('gstAddrPncd', $('#gstAddrPncd_edit').val());
